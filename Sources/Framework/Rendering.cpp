...
{
    static Shader* shader = ResourceManager::LoadResource<Shader>("D:/Game Projects/CG_TermProject/Assets/Shaders/Standard");
    if (!shader)
    {
...
void MeshRenderer::Render() noexcept
{
    ...
    static Shader* const shader = ResourceManager::LoadResource<Shader>("D:/Game Projects/CG_TermProject/Assets/Shaders/Standard");
    if (!shader)
    {
