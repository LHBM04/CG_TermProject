...
#pragma endregion
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformInt(const char* const name_, const int value_) noexcept;
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformFloat(const char* const name_, const float value_) noexcept;
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformVector2(const char* const name_, const glm::vec2& value_) noexcept;
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformVector3(const char* const name_, const glm::vec3& value_) noexcept;
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformVector4(const char* const name_, const glm::vec4& value_) noexcept;
     ...
     * @param value_ 설정할 값.
     */
    static inline void SetUniformMatrix4x4(const char* const name_, const glm::mat4& value_) noexcept;
...
private:
     ...
     */
    [[nodiscard]]
    static GLuint CompileShader(GLenum type_, std::string_view source_) noexcept;
